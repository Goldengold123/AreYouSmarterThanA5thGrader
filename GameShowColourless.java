...
public class GameShow {
    ...
    // If 0 is entered, an exception is thrown: since the input was invalid, program
    // should return to main menu instead of managing input.
    ...
    public static void instructions() throws InterruptedException {
        ...
        // condensed into 1 line so entirety could be selected easily when editing code;
        // to read instructions in the IDE, use word wrap
        System.out.println(
                "Welcome to the game - Are You Smarter Than A 5th Grader!!!\n\n\nThere are a total of 10 + 1 final challenging questions for you to answer.\nAs you progress, the money ladder increases - you win more money.\nYou can use any capitalization for you answers but they should be the simplest answer possible (i.e. 1 instead of one). \n\nAt any point in the game, you may choose to drop out of school and keep your earnings: enter drop out to do so.\n\nIf you get the question correct, you will advance onto the next question.\n\nIf you get the question incorrect, you will either lose all of your earnings or leave with $25,000.\n\n\nLifeline System: these can only be used in the intial 10 questions - you must complete the final question yourself.\n\n1. peek - shown your classmate's answer for a brief moment before being prompted for your own answer\n\n2. copy - forced to use your classmate's answer, regardless of whether it is correct or not\n\n3. save - classmate's answer is automatically deployed when you get a question incorrect\n\n\nThroughout the game, if you wish to return to the main menu, enter 0.\n\n\nGood luck and have fun!\n");
    ...
    public static void instructionsDetailed() throws InterruptedException {
        // Display instructions
        clearScreen();
        printHeader("INSTRUCTIONS DETAILED");
    ...
    public static void game() throws LineUnavailableException, InterruptedException {
        ...
        String[][][] questions = {
                ...
                { // final question
                        { "A long time ago, several continents were contiguous with each other. What was the name of this singular continent?",
                                "pangaea",
                                "no cheats!" },
            ...
            while (gameScreen && alive) {
                ...
                if (response.equalsIgnoreCase("copy")) { // user wants to use copy lifeline
                    ...
                    if (save) { // user has save lifeline available for use
                        ...
                        System.out.print(
                                "\nIncorrect! You have been saved with your classmates answer: "
                                        + classmateAnswer + "");

                        if (!response.equalsIgnoreCase(a)) { // classmates answer is incorrect, finishes sentence from
                                                             // above
        ...
        if (gameScreen) { // user is still in the game (0 was not inputted)
            ...
            // closing screen if user is still on gameScreen (i.e. if 0 was inputted, this
            // is skipped and user is returned to main menu)
            while (gameScreen) {
                // prompt message
                // this is a component of the classic game as described on wikipedia: when
                // player leaves, they have to answer (on camera) whether they are smarter than
                // a 5th grader
                printHeader(
