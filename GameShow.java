            ...
            while (gameScreen && alive) {
                ...
                if (response.equalsIgnoreCase("copy")) {
                    ...
                    if (!peek) {
                        ...
                        System.out.println(
                                "\nYou peek at your classmate's answer: \u001b[33m" + classmateAnswer
                                        + "\u001b[37m. Your turn to answer!\n");
                        peek = true;
                    } else {
                    ...
                    if (save) {
                        ...
                        save = false;
                        System.out.print(
                                "\n\u001b[31mIncorrect!\u001b[37m You have been saved with your classmates answer: \u001b[33m"
                                        + classmateAnswer + "\u001b[37m");
                        response = classmateAnswer;
            ...
            if (!alive) {
                ...
                try {
                    ...
                    if (response.equalsIgnoreCase(a)) {
                        ...
                        // user is incorrect
                        printHeader("\nUnlucky. The correct answer was \u001b[32m" + a
                                + "\u001b[37m. But you still win $25,000 for getting this far!");
                    }
                    wait(4000);
                } catch (Exception e) {
